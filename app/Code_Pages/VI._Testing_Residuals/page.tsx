...
export default function OverviewPage() {
  const htmlFilePath = path.join(process.cwd(), "app/Code_Pages/VI._Testing_Residuals/06_VI.White_Noise_test_of_Residuals.html");
      ...
      <nav className="mb-6">
        <div className="flex flex-wrap items-center justify-between">
          ...
          <ul className="flex flex-wrap justify-center gap-2 sm:gap-3 text-sm list-none p-0 m-0 flex-grow">
            ...
            <li><a href="/Code_Pages/VI._Testing_Residuals" className="hover:underline text-orange-800 whitespace-nowrap">Residual Testing</a></li>
            <li><a href="/Code_Pages/VII._Evaluation" className="hover:underline text-blue-900 whitespace-nowrap">Evaluation</a></li>
          </ul>
